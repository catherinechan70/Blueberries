...
SpecLib <- read.csv("bb3_2_categor_hyperspec_SpecLib_Derivs.csv")
...
remove_names<-c("ScanID","Class1","Class2","Class4","Area","Class2_Freq"
                ,"Class3_Freq","Class4_Freq","SN", "x","y")
# Remove Unwanted columns
...
ggsave("Model_errors_bb3_categor2.jpg")
...
ImportantVarsFrame35%>%
  ...
  geom_bar(stat = "identity")+
  coord_flip()+
  ggtitle("Irrigated/Non-Irrigated 35 Most Important Variables")

ggsave("Important_Variables_bb3_condition2.jpg")
...
#$B_5_Most_ImpVariables
#[1] 0.1259259
#
#$B_10_Most_ImpVariables
#[1] 0.1481481
#
#$B_15_Most_ImpVariables
#[1] 0.08888889
#
#$B_20_Most_ImpVariables
#[1] 0.08888889
#
#$B_25_Most_ImpVariables
#[1] 0.1259259
#
#$B_30_Most_ImpVariables
#[1] 0.1259259
#
#$B_35_Most_ImpVariables
#[1] 0.0962963
#
#$B_40_Most_ImpVariables
#[1] 0.1037037
#
#$B_45_Most_ImpVariables
#[1] 0.0962963
#
#$B_50_Most_ImpVariables
#[1] 0.1111111
...
error_df%>%
  ...
  geom_bar(stat = "identity")+
  coord_flip()+
  ggtitle("Categorical Model Errors of Most Important Variables")

ggsave("Model_errors_VarImp_bb3_categor_2.jpg")

list2env(Modslist ,.GlobalEnv)

# saves the model with the lowest error
save(B_25_Most_ImpVariables, file = "Best_Model25vars_bb3_categor2_hyperspec.rda")
