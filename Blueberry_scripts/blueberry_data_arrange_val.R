...
setwd("E:/Blueberries/ImageExtractions/06072019/BB1Val/") # Set path for 06072019 samples
mypath_bb1 = "/Blueberries/ImageExtractions/06072019/BB1Val/"
...
write.csv(bb1_Df,"E:/Blueberries/ROutputs/bb1_val_Df.csv", row.names = FALSE)



# 07032019

setwd("E:/Blueberries/ImageExtractions/07032019/BB2Val/") # Set path for 06072019 samples
mypath_bb2 = "/Blueberries/ImageExtractions/07032019/BB2Val/"
# Import names of blueberry 1 sample tif files into character list
...
### Write out csv file for water potential / categorical dataframe
write.csv(bb2_Df,"E:/Blueberries/ROutputs/bb2_val_Df.csv", row.names = FALSE)


# 07252019

setwd("E:/Blueberries/ImageExtractions/07252019/BB3Val/") # Set path for 06072019 samples
mypath_bb3 = "/Blueberries/ImageExtractions/07252019/BB3Val/"
# Import names of blueberry 1 sample tif files into character list
...
### Write out csv file for water potential / categorical dataframe
write.csv(bb3_Df,"E:/Blueberries/ROutputs/bb3_val_Df.csv", row.names = FALSE)
...
write.csv(allbb_Df,"E:/Blueberries/ROutputs/allbb_val_Df.csv", row.names = FALSE)
